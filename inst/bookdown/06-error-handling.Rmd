...
```{r 08-error-handling-2, error = TRUE}
task = mlr_tasks$get("spam")
learner = mlr_learners$get("classif.debug")
...
```{r 08-error-handling-6, error = TRUE}
e$predict()
```
